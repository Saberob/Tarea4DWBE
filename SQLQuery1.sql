...
insert into Empleado values ('Rodrigo','Hernandez','Ochoa', 'A9890DEA9');
insert into Empleado values ('Jorge Alberto','Sanchez','Robles','8EBE92AD9');
insert into Empleado values ('Juan Alberto','Garza','Robles', 'A98C90DE9');
insert into Empleado values ('Frida Sofia','Alvarez','Reyes','8EB9E2AD9');
insert into Empleado values ('Julieta','Nuñez','Arrellano', 'A989Q0DE9');
insert into Empleado values ('Gerardo','Sanchez','Mondragon','8EB92AD9Q');
insert into Empleado values ('Rosa Maria','Hernandez','Garcia', 'A98Q90DE9');
insert into Empleado values ('Fernanda','Garza','Gonzalez','98EB92AD9');
